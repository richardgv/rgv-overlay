...
inherit linux-mod linux-info versionator eutils compat-drivers-3.9
...
SRC_URI="mirror://kernel/linux/kernel/projects/backports/stable/v${UPSTREAM_PVR}/${PN}-${UPSTREAM_PVR}-2-su.tar.xz"
...
S="${WORKDIR}/${PN}-${UPSTREAM_PVR}-2-su"
